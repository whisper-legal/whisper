...
const T = {
  ...
  sr: {
    nav_enter: "Uđi u aplikaciju",
    hero_badge: "AI glasovni asistent",
    hero_title: "Tvoj AI glasovni asistent na 35+ jezika",
    hero_sub: "Prevodi, transkribuj, sažmi sastanke i uči pametnije — samo glasom.",
    hero_cta: "Probaj besplatno 14 dana",
    feat_title: "Sve što ti treba",
    feat_sub: "Jedna aplikacija. Beskrajne glasovne mogućnosti.",
    features: [
      { icon: "🌍", title: "Prevod", desc: "35+ jezika odmah" },
      { icon: "🎙️", title: "Transkripcija", desc: "Glas u tekst" },
      { icon: "📋", title: "Sastanak AI", desc: "Auto sažetak" },
      { icon: "🎓", title: "Škola AI", desc: "Tutor + anti-cheat" },
      { icon: "🔔", title: "Podsetnici", desc: "Glasovni podsetnici" },
      { icon: "💬", title: "Whisper AI", desc: "Pametni glasovni asistent" },
    ],
    price_title: "Jednostavne cene",
    price_starting: "Planovi već od €4.99/mes",
    price_trial: "14 dana besplatno uključeno",
    enter_app: "Uđi u aplikaciju",
    footer_tagline: "Tvoj AI glasovni pratilac.",
  },
  hr: {
    nav_enter: "Uđi u aplikaciju",
    hero_badge: "AI glasovni asistent",
    hero_title: "Tvoj AI glasovni asistent na 35+ jezika",
    hero_sub: "Prevodi, transkribiraj, sažmi sastanke i uči pametnije — samo glasom.",
    hero_cta: "Isprobaj besplatno 14 dana",
    feat_title: "Sve što ti treba",
    feat_sub: "Jedna aplikacija. Beskrajne glasovne mogućnosti.",
    features: [
      { icon: "🌍", title: "Prijevod", desc: "35+ jezika odmah" },
  ...
  de: {
    nav_enter: "App öffnen",
    hero_badge: "KI-Sprachassistent",
    hero_title: "Dein KI-Sprachassistent in 35+ Sprachen",
    hero_sub: "Übersetze, transkribiere, fasse Meetings zusammen und lerne smarter — mit deiner Stimme.",
    hero_cta: "14 Tage gratis testen",
    feat_title: "Alles, was du brauchst",
    feat_sub: "Eine App. Endlose Sprachmöglichkeiten.",
    features: [
      { icon: "🌍", title: "Übersetzung", desc: "35+ Sprachen sofort" },
      { icon: "🎙️", title: "Transkription", desc: "Sprache zu Text" },
      { icon: "📋", title: "Meeting-KI", desc: "Auto-Zusammenfassung" },
      { icon: "🎓", title: "Schul-KI", desc: "Tutor + Anti-Betrug" },
      { icon: "🔔", title: "Erinnerungen", desc: "Spracherinnerungen" },
      { icon: "💬", title: "Whisper AI", desc: "Smarter Sprachassistent" },
    ],
    price_title: "Einfache Preise",
    price_starting: "Pläne ab €4,99/Monat",
    price_trial: "14 Tage gratis inklusive",
    enter_app: "App öffnen",
    footer_tagline: "Dein KI-Sprachbegleiter.",
  },
  sv: {
    nav_enter: "Gå till appen",
    hero_badge: "AI-röstassistent",
    hero_title: "Din AI-röstassistent på 35+ språk",
    hero_sub: "Översätt, transkribera, sammanfatta möten och lär smartare — med din röst.",
    hero_cta: "Prova gratis i 14 dagar",
    feat_title: "Allt du behöver",
    feat_sub: "En app. Oändliga röstmöjligheter.",
    features: [
      { icon: "🌍", title: "Översättning", desc: "35+ språk direkt" },
      { icon: "🎙️", title: "Transkription", desc: "Tal till text" },
      { icon: "📋", title: "Mötes-AI", desc: "Auto-sammanfattning" },
      { icon: "🎓", title: "Skol-AI", desc: "Tutor + anti-fusk" },
      { icon: "🔔", title: "Påminnelser", desc: "Röstpåminnelser" },
      { icon: "💬", title: "Whisper AI", desc: "Smart röstassistent" },
    ],
    price_title: "Enkla priser",
    price_starting: "Planer från €4,99/mån",
    price_trial: "14 dagar gratis ingår",
    enter_app: "Gå till appen",
    footer_tagline: "Din AI-röstassistent.",
  },
  no: {
