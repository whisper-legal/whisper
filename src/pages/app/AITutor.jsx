...
import { Send, Mic, Square, Trash2, Sparkles, ShieldCheck } from "lucide-react";
...
Respond as a tutor: guide, explain, ask questions — but never do the work for them:`,
    });
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Anti-cheat badge */}
      <div className="shrink-0 mx-4 mt-3 mb-1 px-3 py-2 rounded-xl flex items-center gap-2"
        style={{ background: "rgba(16,185,129,0.08)", border: "1px solid rgba(16,185,129,0.2)" }}>
        <ShieldCheck className="w-4 h-4 text-emerald-400 shrink-0" />
        <p className="text-emerald-400 text-[10px] tracking-wide leading-snug">
          Anti-cheat mod aktivan — AI objašnjava i vodi, ne rješava zadatke umjesto tebe.
        </p>
      </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-4 py-12 text-center">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs leading-relaxed max-w-[220px]">
                Postavi pitanje o gradivu. AI će ti pomoći da RAZUMIJEŠ — ali neće raditi zadatke umjesto tebe.
              </p>
            </div>
          </div>
        )}
      ...
      <div className="shrink-0 px-4 pb-4 pt-2 border-t border-slate-800 flex gap-2 items-end">
        <div className="flex-1 rounded-2xl px-4 py-3 flex items-end gap-2"
          ...
          <textarea
            ...
            onKeyDown={handleKey}
            placeholder="Postavi pitanje o gradivu..."
            rows={1}
        ...
        <button
          ...
          {voiceActive ? <Square className="w-4 h-4 fill-white text-white" /> : <Mic className="w-4 h-4 text-slate-400" />}
        </button>
